...
namespace Gnu.MP
{
    ...
    public class Real : IComparable<Real>, IComparable, ICloneable
    {
        ...
        [DllImport("gmp", EntryPoint = "__gmpf_init")]
        ...
        [DllImport("gmp", EntryPoint = "__gmpf_set_default_prec")]
        ...
        [DllImport("gmp", EntryPoint = "__gmpf_set_z")]
        private static extern void mpf_set_z(ref mpf_t rop, ref mpz_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_set_q")]
        ...
        [DllImport("gmp", EntryPoint = "__gmpf_get_si")]
        ...
        [DllImport("gmp", EntryPoint = "__gmpf_add_ui")]
        ...
        [DllImport("gmp", EntryPoint = "__gmpf_sub_ui")]
        private static extern void mpf_sub_ui(ref mpf_t rop, ref mpf_t op1, uint op2);

        [DllImport("gmp", EntryPoint = "__gmpf_ui_sub")]
        ...
        [DllImport("gmp", EntryPoint = "__gmpf_mul_ui")]
        ...
        [DllImport("gmp", EntryPoint = "__gmpf_div_ui")]
        private static extern void mpf_div_ui(ref mpf_t rop, ref mpf_t op1, uint op2);

        [DllImport("gmp", EntryPoint = "__gmpf_ui_div")]
