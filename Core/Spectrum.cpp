...
namespace Hrt
{
	...
	const number Spectrum::XyzMatching[LambdaCount][3] = {
		{(number)0.0014,(number)0.0000,(number)0.0065}, // 380
		{(number)0.0022,(number)0.0001,(number)0.0105}, 
		{(number)0.0042,(number)0.0001,(number)0.0201}, // 390
		{(number)0.0076,(number)0.0002,(number)0.0362}, 
		{(number)0.0143,(number)0.0004,(number)0.0679}, // 400
		{(number)0.0232,(number)0.0006,(number)0.1102},
		{(number)0.0435,(number)0.0012,(number)0.2074}, // 410
		{(number)0.0776,(number)0.0022,(number)0.3713}, 
		{(number)0.1344,(number)0.0040,(number)0.6456}, // 420
		{(number)0.2148,(number)0.0073,(number)1.0391}, 
		{(number)0.2839,(number)0.0116,(number)1.3856}, // 430
		{(number)0.3285,(number)0.0168,(number)1.6230}, 
		{(number)0.3483,(number)0.0230,(number)1.7471}, // 440
		{(number)0.3481,(number)0.0298,(number)1.7826}, 
		{(number)0.3362,(number)0.0380,(number)1.7721}, // 450
		{(number)0.3187,(number)0.0480,(number)1.7441}, 
		{(number)0.2908,(number)0.0600,(number)1.6692}, // 460
		{(number)0.2511,(number)0.0739,(number)1.5281},
		{(number)0.1954,(number)0.0910,(number)1.2876}, // 470
		{(number)0.1421,(number)0.1126,(number)1.0419}, 
		{(number)0.0956,(number)0.1390,(number)0.8130}, // 480
		{(number)0.0580,(number)0.1693,(number)0.6162}, 
		{(number)0.0320,(number)0.2080,(number)0.4652}, // 490
		{(number)0.0147,(number)0.2586,(number)0.3533},
		{(number)0.0049,(number)0.3230,(number)0.2720}, // 500
		{(number)0.0024,(number)0.4073,(number)0.2123}, 
		{(number)0.0093,(number)0.5030,(number)0.1582}, // 510
		{(number)0.0291,(number)0.6082,(number)0.1117}, 
		{(number)0.0633,(number)0.7100,(number)0.0782}, // 520
		{(number)0.1096,(number)0.7932,(number)0.0573},
		{(number)0.1655,(number)0.8620,(number)0.0422}, // 530
		{(number)0.2257,(number)0.9149,(number)0.0298}, 
		{(number)0.2904,(number)0.9540,(number)0.0203}, // 540
		{(number)0.3597,(number)0.9803,(number)0.0134}, 
		{(number)0.4334,(number)0.9950,(number)0.0087}, // 550
		{(number)0.5121,(number)1.0000,(number)0.0057},
		{(number)0.5945,(number)0.9950,(number)0.0039}, // 560
		{(number)0.6784,(number)0.9786,(number)0.0027}, 
		{(number)0.7621,(number)0.9520,(number)0.0021}, // 570
		{(number)0.8425,(number)0.9154,(number)0.0018}, 
		{(number)0.9163,(number)0.8700,(number)0.0017}, // 580
		{(number)0.9786,(number)0.8163,(number)0.0014},
		{(number)1.0263,(number)0.7570,(number)0.0011}, // 590
		{(number)1.0567,(number)0.6949,(number)0.0010}, 
		{(number)1.0622,(number)0.6310,(number)0.0008}, // 600
		{(number)1.0456,(number)0.5668,(number)0.0006}, 
		{(number)1.0026,(number)0.5030,(number)0.0003}, // 610
		{(number)0.9384,(number)0.4412,(number)0.0002},
		{(number)0.8544,(number)0.3810,(number)0.0002}, // 620
		{(number)0.7514,(number)0.3210,(number)0.0001}, 
		{(number)0.6424,(number)0.2650,(number)0.0000}, // 630
		{(number)0.5419,(number)0.2170,(number)0.0000}, 
		{(number)0.4479,(number)0.1750,(number)0.0000}, // 640
		{(number)0.3608,(number)0.1382,(number)0.0000},
		{(number)0.2835,(number)0.1070,(number)0.0000}, // 650
		{(number)0.2187,(number)0.0816,(number)0.0000}, 
		{(number)0.1649,(number)0.0610,(number)0.0000}, // 660
		{(number)0.1212,(number)0.0446,(number)0.0000}, 
		{(number)0.0874,(number)0.0320,(number)0.0000}, // 670
		{(number)0.0636,(number)0.0232,(number)0.0000},
		{(number)0.0468,(number)0.0170,(number)0.0000}, // 680
		{(number)0.0329,(number)0.0119,(number)0.0000}, 
		{(number)0.0227,(number)0.0082,(number)0.0000}, // 690
		{(number)0.0158,(number)0.0057,(number)0.0000}, 
		{(number)0.0114,(number)0.0041,(number)0.0000}, // 700
		{(number)0.0081,(number)0.0029,(number)0.0000},
		{(number)0.0058,(number)0.0021,(number)0.0000}, // 710
		{(number)0.0041,(number)0.0015,(number)0.0000}, 
		{(number)0.0029,(number)0.0010,(number)0.0000}, // 720
		{(number)0.0020,(number)0.0007,(number)0.0000}, 
		{(number)0.0014,(number)0.0005,(number)0.0000}, // 730
		{(number)0.0010,(number)0.0004,(number)0.0000},
		{(number)0.0007,(number)0.0002,(number)0.0000}, // 740
		{(number)0.0005,(number)0.0002,(number)0.0000}, 
		{(number)0.0003,(number)0.0001,(number)0.0000}, // 750
		{(number)0.0002,(number)0.0001,(number)0.0000}, 
		{(number)0.0002,(number)0.0001,(number)0.0000}, // 760
		{(number)0.0001,(number)0.0000,(number)0.0000},
		{(number)0.0001,(number)0.0000,(number)0.0000}, // 770
		{(number)0.0001,(number)0.0000,(number)0.0000}, 
		{(number)0.0000,(number)0.0000,(number)0.0000}  // 780
	};
